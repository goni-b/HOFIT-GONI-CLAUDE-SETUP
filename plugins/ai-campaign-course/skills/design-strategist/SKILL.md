...
description: |
  ...
  Outputs a Design Brief JSON that the hofit-goni-design-agent consumes.
version: 1.0.0
---
...
3. **The orchestrator will automatically invoke** `/hofit-goni-design-agent` in the SAME conversation

**NEVER output:**
- ❌ "העתק את ה-Design Brief"
- ❌ "פתח שיחה חדשה עם hofit-goni-design-agent"
- ❌ "דרך 3 — בנייה"
...
### 1. WOW Dark Premium (Default "Hofit & Goni Style")
...
- `hofit-goni-copy-agent` — generates the copy you analyze
- `hofit-goni-design-agent` — builds the page from your brief
